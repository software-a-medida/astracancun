...
<body>
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item">
                            <div class="dropmenu menu-right">
                                <button class="btn btn-b-none waves-effect waves-light no-focus"><span
                                        class="status_session"></span> <?= Session::get_value('__user') ?></button>
                                <div class="dropdown">
                                    <a href="index.php/media">Multimedia</a>
                ...
                <ul class="navigation-menu list-inline m-0">
                    <li class="menu-item visible-phone visible-tablet">
                        <button id="trigger-nav-mobile" type="button"
                            class="btn btn-b-none waves-effect waves-light menu-wrapper">
            ...
            <nav class="main-menu">
                <ul class="navigation-menu list-inline">
                    ...
                    <li <?= (isset($value['submenu'])) ? 'class="has-submenu"' : '' ?>>
                        <a href="<?= $value['url'] ?>"
                            <?= (isset($value['target'])) ? "target=\"{$value['target']}\"" : "" ?>><?= (isset($value['icon'])) ? "<i class='{$value['icon']}'></i>" : "" ?>
                            <?= $value['name'] ?></a>
                        ...
                        <ul class="submenu list-unstyled">
                            ...
                            <li>
                                <a href="<?= $submenu['url'] ?>"
                                    <?= (isset($submenu['target'])) ? "target=\"{$submenu['target']}\"" : "" ?>><?= (isset($submenu['icon'])) ? "<i class='{$submenu['icon']}'></i>" : "" ?>
                                    <?= $submenu['name'] ?></a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
    ...
    <footer class="footer d-print-none">
        <div class="container">
            © <?= date('Y') ?> <b>{$_webpage}</b> <i class="mdi mdi-heart text-danger"></i> by <a
                href="https://codemonkey.com.mx" target="_blank">codemonkey.com.mx</a>
        </div>
    </footer>
    <!-- End Footer -->
    ...
    <script src="{$path.plugins}alertify/alertify.min.js"></script>
