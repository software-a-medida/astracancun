...
!function ($) {
    ...
    app.prototype.onload = function () {
        ...
        app.prototype.uploadImagePreview = function (selector = "") {
            if (selector !== "") {
                $(document).on('change', selector, function () {
                    ...
                    if (self[0].files[0]) {
                        let ajax = $(document).ajaxSubmit({
                            ...
                            httpError: function (request, error) {
                                alertify.error(request.status + ': ' + request.statusText);
                            },
