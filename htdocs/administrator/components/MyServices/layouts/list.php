...
use \BuriPHP\System\Libraries\{Dates, Security};
use \BuriPHP\Administrator\Components\MyServices\Component;

// Pages
$this->dependencies->add(['js', '{$path.components}MyServices/assets/js/delete.js?v=1.0.0']);
...
$this->dependencies->add(['other', '<script>$.app.addButtonsAction({
    "button": {
        ...
        "href": "index.php/services/create"
    }
})</script>']);
?>
<main class="wrapper">
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="myservices" class="table mb-0" style="font-size: 14px; min-width: 1000px">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Servicio</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="table-empty" colspan="8">
                                            <p class="m-0 text-muted">Sin servicios.</p>
                                        </td>
                                    </tr>
                                    <?php endif; ?>
                                        ...
                                        <td>
                                            <div class="content-cell">
                                                <div class="button-items text-right">
                                                    ...
                                                    <a href="index.php/services/update?id=<?= $value['id'] ?>"
