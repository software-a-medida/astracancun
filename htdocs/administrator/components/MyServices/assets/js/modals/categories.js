$(document).ready(function () {
    ...
    $.get('index.php/services/categories/list', function (data) {
        if (data.status == 'OK') {
    ...
    $('#categories form[name="create"]').ajaxSubmit({
        url: 'index.php/services/categories/create',
        ...
        swal({
            ...
            preConfirm: function () {
                return new Promise(function (resolve) {
                    $.post('index.php/services/categories/delete', { id: self.data('ajax-delete') }, function (data) {
                        if (data.status == 'OK') {
                            xhr_status = 'OK';
                        }
                        else {
