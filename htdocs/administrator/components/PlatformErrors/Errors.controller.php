...
namespace BuriPHP\Administrator\Components\PlatformErrors\Controllers;
...
class Errors
{
	...
	public function not_found()
	{
		...
		return $this->view->render(Component::LAYOUTS . 'not_found.php');
	}

	public function Permission_denied()
	{
		define('_title', 'Permisos denegados - Panel de Control - ' . \BuriPHP\Configuration::$web_page);
		return $this->view->render(Component::LAYOUTS . 'permission_denied.php');
	}
}