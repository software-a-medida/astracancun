    ...
    <main id="main-content">
                ...
                <div class="item text-center">
                    <div class="background">
                        <!-- <figure class="elm-stretched m-0">
                            <img src="{$path.uploads}" class="img-cover">
                        </figure> -->
                    </div>
        ...
        <section class="bg-primary p-tb-50">
            ...
            <div class="container text-secondary font-20">
                ...
                <p class="text-justify m-b-0">Una institución especializada que brinda atención integral a personas con
                    Autismo y otros Trastornos del Neurodesarrollo, desde los 18 meses a la vida adulta a través de
                    distintos programas terapéuticos y educativos. Con más de 20 años de experiencia hemos logrado
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <script async defer crossorigin="anonymous"
                            src="https://connect.facebook.net/es_ES/sdk.js#xfbml=1&version=v14.0" nonce="rYwv4Os8">
                        </script>

                        <div class="fb-page" data-href="https://www.facebook.com/astracancun/" data-tabs="timeline"
                            data-width="" data-height="400" data-small-header="false" data-adapt-container-width="true"
                            data-hide-cover="false" data-show-facepile="false" style="width: 100%;">
                            <blockquote cite="https://www.facebook.com/astracancun/" class="fb-xfbml-parse-ignore"><a
                                    href="https://www.facebook.com/astracancun/">ASTRA-CANCUN</a></blockquote>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <a class="twitter-timeline" data-height="400"
                            href="https://twitter.com/AstraCancun?ref_src=twsrc%5Etfw">Tweets by AstraCancun</a>
