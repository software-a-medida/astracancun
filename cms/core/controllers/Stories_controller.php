	...
	** Render: Page
	...
	public function index()
	{
		...
		else
		{
			...
			$datas = $this->model->get('all', ['id_storie','name','cover','priority']);
			...
			foreach ($datas as $value)
			{
				...
				'<tr>
					...
					<td>
						<a data-action="delete" data-id="' . $value['id_storie'] . '"><i class="material-icons">delete</i><span>Eliminar</span></a>
						<a data-action="get" data-id="' . $value['id_storie'] . '"><i class="material-icons">menu</i><span>Detalles | Editar</span></a>
						<div class="clear"></div>
					</td>
				</tr>';
			}
