...
$this->dependencies->add(['js','{$path.js}pages/team.min.js']);
    ...
    <div class="content">
        ...
        <main>
            <form name="datas" data-submit-action="new">
                ...
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Pocisión (ES)</h6>
                        <textarea name="position_es"></textarea>
                    </div>
                </fieldset>
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Pocisión (EN)</h6>
                        <textarea name="position_en"></textarea>
                    </div>
                </fieldset>
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Funciones y Responsabilidades (ES)</h6>
                        <textarea name="semblance_es"></textarea>
                    </div>
                </fieldset>
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Funciones y Responsabilidades (EN)</h6>
                        <textarea name="semblance_en"></textarea>
                    </div>
                </fieldset>
                <fieldset class="fields-group">
                    <div class="uploader" data-low-uploader>
                        <h6><span class="required-field">*</span>Imagen de perfil</h6>
                        <figure data-preview>
                            <img src="{$path.images}empty.png">
                        </figure>
                        <a class="btn" data-select>Seleccionar imagen</a>
                        <input type="file" id="avatar" name="avatar" accept="image/*" data-select>
                    </div>
                </fieldset>
                <fieldset class="fields-group">
                    <div class="text">
