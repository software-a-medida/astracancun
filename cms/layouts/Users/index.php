...
$this->dependencies->add(['js','{$path.js}pages/users.min.js']);
    ...
    <div class="content">
        ...
        <main>
            <form name="datas" data-submit-action="new">
                ...
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Nombre completo</h6>
                ...
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Usuario</h6>
                        <input type="text" name="username">
                    </div>
                </fieldset>
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Contraseña</h6>
                        <input type="password" name="password">
                    </div>
                </fieldset>
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Nivel de acceso</h6>
                        <select name="level">
                            {$lst_users_levels}
                        </select>
                    </div>
                ...
                <fieldset class="fields-group">
                    <div class="text">
                        <h6><span class="required-field">*</span>Estado</h6>
                        <select name="status">
