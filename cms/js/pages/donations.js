...
$(document).ready(function()
{
   ...
   $('[data-action="get"]').on('click', function()
   {
       ...
       $.ajax({
           ...
           success: function(response)
           {
               ...
               {
                   $('input[name="description_es"]').val(response.data.description.es);
                   $('input[name="description_en"]').val(response.data.description.en);
   ...
   $('form[name="datas"]').on('submit', function(e)
   {
       ...
       $.ajax({
           url: '',
           type: 'POST',
           data: data + '&id=' + id + '&action=' + $(this).data('submit-action'),
           processData: false,
           cache: false,
           dataType: 'json',
           success: function(response)
